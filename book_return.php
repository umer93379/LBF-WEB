...
<?php
  ...
  $SQL="SELECT * FROM borrow_book WHERE bb_date_returned='0000-00-00'";
...
<table class="table table-hover">
    ...
    ?>
     <tr>
        ...
        <td><?php echo $data['s_cnic']?></td>
        <td>
           <?php
           // calculating number of days book borrowed
             
              $date_issued = $data['bb_date_issued'];
              $date_now=date('Y/m/d');
              $datetime1 = date_create($date_issued);
        ...
        <form action="php/db.php" method="POST">
          <input type="hidden" name="bb_id" value="<?php echo $data['bb_id']?>">
          <input type="hidden" name="act" value="insert_return_book">
